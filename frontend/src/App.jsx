...
// import { useAuth } from './context/AuthContext'; // is this all we need
...
//   const [error, setError] = useState('');  // why this 
...
//     try {
//       await login(username, password); // don't we need to import login first
//       // Login successful - context will update automatically
//     } catch (err) {
//       const errorMessage = err.response?.data?.non_field_errors?.[0]  // what is even this
...
//     try {
//       await connectWallet(); // where is connectWallet import
//     } catch (err) {
